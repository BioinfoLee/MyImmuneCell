...
{    
   ...
   colors = pal(length(breaks)-1)
   image(1, seq(min(snpCorr^2), max(snpCorr^2), length.out = length(colors)),
      t(matrix(seq(min(snpCorr^2), max(snpCorr^2), length.out = length(colors)), ncol = 1)),
      col = colors, xlab = "", ylab = "", xaxt = "n", yaxt = "n", bty = "n")

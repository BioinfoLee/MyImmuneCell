...
#设置bed文件所在的文件夹路径
bed_dir = '/media/AnalysisDisk2/Yangshichen/2_My-Onek/WES/Germline/Data/scADT-seq/06.protein_expression_bed/'
output_dir = '/media/AnalysisDisk2/Yangshichen/2_My-Onek/WES/Germline/Result/pQTL/'
...
for bed_file in bed_files:
    ...
    #保存
    cis_df.to_csv(f'{folder_path}/caQTL_all_lead_perm_qvalue.csv')
...
print(len(cis_df_all[cis_df_all['study_wise_qval'] < 0.05]['phenotype_id'].unique())) #29
print(len(cis_df_all[cis_df_all['celltype_level_qval'] < 0.05]['phenotype_id'].unique())) #29

cis_df_all.to_csv('/media/AnalysisDisk2/Yangshichen/2_My-Onek/WES/Germline/Result/pQTL_all_lead_perm_qvalues.csv')

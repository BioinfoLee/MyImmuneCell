...
print(len(cis_df_all[cis_df_all['study_wise_qval'] < 0.05]['phenotype_id'].unique())) #12198
print(len(cis_df_all[cis_df_all['celltype_level_qval'] < 0.05]['phenotype_id'].unique())) #13072

cis_df_all.to_csv('/media/AnalysisDisk2/Yangshichen/2_My-Onek/WGS/Result/eQTL_all_lead_perm_qvalues.csv')

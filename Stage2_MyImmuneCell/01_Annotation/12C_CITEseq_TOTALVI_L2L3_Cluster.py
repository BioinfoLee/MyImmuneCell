...
obj_path = f'/home/liyanguo/MyImmuCell/05_MyImmuCell_subpopulation/Level2_Refine_R2/{dataset}/'
...
def run_leiden_parallel(params):
    global adata
    key_added = f"L3_leiden_TOTALVI_{params['resolution']}"
    sc.tl.leiden(adata, key_added=f'L3_leiden_TOTALVI_{params['resolution']}', 
                 **params,
...
leiden_data = adata.obs.loc[:,['L3_leiden_TOTALVI_0.1','L3_leiden_TOTALVI_0.5', 'L3_leiden_TOTALVI_1', 'L3_leiden_TOTALVI_1.5', 'L3_leiden_TOTALVI_2','L3_leiden_TOTALVI_3']]
obsm = adata.obsm
...
leiden_data.to_csv(f'{obj_path}/Level3_TOTALVI_ForClustree.csv')
os.system(f'/home/liyanguo/anaconda3/envs/R/bin/Rscript clustree_L3.R {obj_path} &')
...
sc.pl.umap(
    ...
    save=f'_{dataset}_TOTALVI_L3_annoy_leiden',show=False
)
...
sc.pl.umap(
    adata,
    color=['Reference_Atlas_L1L2_mv', 'AIFI_L2','AIFI_L3','Immune_All_Low','Adult_Human_Blood','predicted.celltype.l2','scDblFinder.class'],
    legend_fontsize=6,legend_loc='on data',ncols=3,frameon=False,
...
marker_dict1={
    ...
    'T naive': ['CD3D','CD3G','LEF1','IL7R','CCR7', 'TCF7','SELL','BACH2','ITGB1','GPR183'],#ITGB1-
    ...
    'B naive': ['CD79A','TCL1A','IGHA1'],
    'Transitional B': ['MME','CD38','CD9','FCER2','BACH2','PAX5', 'MSI2','NEIL1','CR2'],
...
sc.pl.umap(
    ...
    layer='clr',
    save=f'_{dataset}_scADT_TOTALVI_L3_annoy_leiden'
    )
